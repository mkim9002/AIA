...
from sklearn.preprocessing import MaxAbsScaler, LabelEncoder, MinMaxScaler
...
for _ in range(10):
    ...
    hidden_layer = Dense(60)(hidden_layer)
    hidden_layer = Dropout(0.2)(hidden_layer)
    hidden_layer = ELU()(hidden_layer)
...
# Save the results
submission.to_csv(save_path + 'submit32.csv', index=False)
