...
#1.4.1 reshape
x = np.array(x)
x = x.reshape(5497, 11, 1)

test_csv = np.array(test_csv)
print(test_csv.shape) #(1000,11)
test_csv = test_csv.reshape(1000, 11, 1)
...
model = Sequential()
model.add(SimpleRNN(32, input_shape=(11,1)))
...
path_save = './_save/wine_quality/' 
submission.to_csv(path_save + 'submit_013.csv')
