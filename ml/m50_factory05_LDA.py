...
# Perform LDA
lda = LDA(n_components=10)  # Specify the number of components you want to keep
x = lda.fit_transform(x, y)
test_input_dataset = lda.transform(test_input_dataset)
...
# Save the results
submission.to_csv(save_path + 'submit44.csv', index=False)
