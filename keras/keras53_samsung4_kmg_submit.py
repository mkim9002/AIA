...
model = load_model('./_save/samsung/keras53_samsung4_kmg.h5')
...
hist = model.fit([samsung_x_train_split, hyundai_x_train_split], 
                 ...
                 epochs=2080, batch_size=128, validation_split=0.2, callbacks=[es])

model.save(path_save + 'keras53_samsung4_kmg.h5') #keras53_samsung4_kmg.h5
...
print("현대 시가 : ", np.round(predict_result[1], 2))
