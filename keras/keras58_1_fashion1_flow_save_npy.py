...
np.save(path_save + 'keras58_1_fashion_x_test.npy', arr=x_test)
np.save(path_save + 'keras58_1_fashion_y_train.npy', arr=y_train)
np.save(path_save + 'keras58_1_fashion_y_test.npy', arr=y_test)