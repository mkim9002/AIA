...
x_train = np.load(path_save + 'keras58_9_breed_x_train.npy')
x_test = np.load(path_save + 'keras58_9_breed_x_test.npy')
y_train = np.load(path_save + 'keras58_9_breed_y_train.npy')
y_test = np.load(path_save + 'keras58_9_breed_y_test.npy')
